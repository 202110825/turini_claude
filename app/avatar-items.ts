...
export const CONTENT_BOX: Record<string, [number, number, number, number]> = {
  "hat:chef_hat": [0.099, 0.0885, 0.8958, 0.7422],
  "hat:explorer_hat": [0.1198, 0.3333, 0.8802, 0.8099],
  "hat:gold_crown": [0.1146, 0.2708, 0.8828, 0.8333],
  "hat:graduation_cap": [0.0964, 0.2448, 0.9036, 0.9036],
  "hat:green_cap": [0.1146, 0.3099, 0.8724, 0.849],
  "hat:red_beanie": [0.1354, 0.0833, 0.8698, 0.8047],
  "hat:straw_hat": [0.1016, 0.2448, 0.9036, 0.8594],
  "hat:wizard_hat": [0.1198, 0.099, 0.8802, 0.7474],
  "hat:yellow_bucket": [0.1042, 0.2448, 0.8958, 0.849],
  "glasses:black_square": [0.1016, 0.4661, 0.8958, 0.763],
  "glasses:blue_sport": [0.1068, 0.2682, 0.8854, 0.6641],
  "glasses:gold_round": [0.112, 0.4141, 0.8854, 0.8177],
  "glasses:green_round": [0.1016, 0.3776, 0.901, 0.7917],
  "glasses:heart_sunglasses": [0.1172, 0.263, 0.8854, 0.7578],
  "glasses:monocle": [0.1016, 0.1016, 0.9036, 0.6823],
  "glasses:red_reading": [0.1276, 0.138, 0.9036, 0.599],
  "glasses:safety_goggles": [0.1068, 0.1276, 0.8802, 0.638],
  "glasses:star_glasses": [0.112, 0.2135, 0.8932, 0.8021],
  "neck:blue_scarf": [0.1458, 0.112, 0.8516, 0.888],
  "neck:camera": [0.2188, 0.0729, 0.8958, 0.8177],
  "neck:flower_lei": [0.1172, 0.112, 0.8958, 0.7969],
  "neck:gold_medal": [0.1172, 0.125, 0.862, 0.8724],
  "neck:green_bow": [0.1667, 0.276, 0.8932, 0.8802],
  "neck:pearl_necklace": [0.099, 0.0807, 0.8958, 0.9245],
  "neck:red_tie": [0.1458, 0.1458, 0.776, 0.8906],
  "neck:white_green_collar": [0.1172, 0.1198, 0.8568, 0.7188],
  "neck:yellow_bandana": [0.1016, 0.0807, 0.9036, 0.9245],
  "bag:black_business": [0.099, 0.0833, 0.8984, 0.8177],
  "bag:green_original": [0.1198, 0.112, 0.8854, 0.8776],
  "bag:mint_bubble": [0.138, 0.1198, 0.9036, 0.8724],
  "bag:navy_school": [0.1354, 0.1146, 0.875, 0.875],
  "bag:pink_heart": [0.1406, 0.1224, 0.8984, 0.8724],
  "bag:purple_star": [0.1094, 0.125, 0.8854, 0.9245],
  "bag:red_hiking": [0.1146, 0.0938, 0.888, 0.9245],
  "bag:tan_explorer": [0.1016, 0.0911, 0.9036, 0.9141],
  "bag:yellow_giraffe": [0.1042, 0.1172, 0.888, 0.8802],
...
/** 꾸미기 화면 밖에서 항상 사용하는 액세서리 없는 기본 외형입니다. */
export const BASE_CUSTOMIZATION: TuriniCustomization = {
  hat: null,
  glasses: null,
  neck: null,
  bag: null,
